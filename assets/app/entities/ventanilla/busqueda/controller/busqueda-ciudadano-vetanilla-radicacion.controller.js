...
(function () {
        'use strict';
        angular.module("wpc")
            .controller('VentanillaRadicacionTramiteController', VentanillaRadicacionTramiteController);

        VentanillaRadicacionTramiteController.$inject =
            ['AuthenticationFactory','$scope', 'GarantiasServices', 'NumberService',
                 '$location', 'ngTableParams', '$filter', '$window','$uibModal','$timeout'];

        function VentanillaRadicacionTramiteController(AuthenticationFactory,$scope, GarantiasServices, NumberService,
                                                  $location, ngTableParams, $filter, $window,$uibModal,$timeout) {
            ...
            $scope.openModal = function () {
                var modalInstance = $uibModal.open({
                        templateUrl: 'assets/app/entities/ventanilla/radicacion/view/seleccionar-regional-ventanilla-radicacion.html',
