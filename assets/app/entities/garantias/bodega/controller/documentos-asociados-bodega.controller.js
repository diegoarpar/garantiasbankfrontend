...
(function () {
        'use strict';
        angular.module("wpc")
            .controller('DocumentosAsociadosBodegaController', DocumentosAsociadosBodegaController);

        DocumentosAsociadosBodegaController.$inject = ['AuthenticationFactory','$scope', 'GarantiasServices',  '$location', '$rootScope', '$window', '$route','NgTableParams','$uibModal','$uibModalInstance'];

        function DocumentosAsociadosBodegaController(AuthenticationFactory,$scope, GarantiasServices, $location, $rootScope, $window, $route,NgTableParams,$uibModal,$uibModalInstance) {
