...
(function () {
        'use strict';
        angular.module("wpc")
            .controller('SeleccionarTramiteVentanillaRadicacionController', SeleccionarTramiteVentanillaRadicacionController);

        SeleccionarTramiteVentanillaRadicacionController.$inject =
        ...
        function SeleccionarTramiteVentanillaRadicacionController($scope,AuthenticationFactory,ShareService, GarantiasServices, NumberService,
                                  $location, ngTableParams, $filter, $window,$controller,$sessionStorage,$uibModalInstance) {
