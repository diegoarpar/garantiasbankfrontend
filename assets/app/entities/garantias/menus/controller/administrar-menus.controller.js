...
(function () {
        'use strict';
        angular.module("wpc")
            .controller('ConfiguracionMenuController', ConfiguracionMenuController);

        ConfiguracionMenuController.$inject =
        ...
        function ConfiguracionMenuController($scope,AuthenticationFactory,ShareService, GarantiasServices, NumberService, CamposGenericosServices,
                                 CamposEspecificosServices,CamposParametricosServices, $location, ngTableParams, $filter, $window,$controller,$sessionStorage,$uibModal) {
            ...
            $scope.showModal = false;
                ...
                //ShareService.setContxt(context);
                    var modalInstance = $uibModal.open({
                            templateUrl: 'assets/app/entities/garantias/menus/view/crear-menus.html',
