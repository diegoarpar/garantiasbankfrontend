...
(function(){
        ...
        function IdoneidadController($scope, GarantiasServices,NumberService,CamposGenericosServices,
                                                  CamposEspecificosServices, $location,ngTableParams,$filter,$window) {
            $scope.all_columns=[];
            $scope.columns=[];
            $scope.digital=[];
            ...
            $scope.catchGarantias = function () {
                ...
                $scope.columns=[];
                $scope.all_columns=[];
                $scope.digital= GarantiasServices.show({tula:$scope.tula,enviadoTula:"true",garantiaRecibida:"true",validacionidoneidad:"false"});
            ...
            function datosFillComplementarios($scope,gt, service){
                $scope.datoscomplementariosgenericos=service.show({fieldType:"idoneidad",garantiaType:"-1"});
                $scope.datoscomplementariosespecificos=service.show({fieldType:"idoneidad",garantiaType:gt});
